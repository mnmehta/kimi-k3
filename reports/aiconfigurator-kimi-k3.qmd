...
| **TP8×DP2** | TP8 × PP1 × DP2 | AIC: MoE TP16 × EP1 | 16 | Ground truth uses two TP8 replicas without EP; AIC models the equivalent global width because its MoE dimensions must match TP×DP. |
