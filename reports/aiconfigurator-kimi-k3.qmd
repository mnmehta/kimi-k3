...
for column in ["Target C", "AIC batch", "AIC C"]:
    number_formats[column] = "{:.0f}"
...
for col in ["TTFT", "TPOT", "Output throughput"]:
    mape[col] = pd.to_numeric(mape[col], errors="coerce")
mape_formats = {col: "{:.1f}%" for col in ["TTFT", "TPOT", "Output throughput"]}
mape_formats["Points compared"] = "{:.0f}"
styled_mape = mape.style.format(mape_formats, na_rep="—").map(
    error_cell_style,
    subset=["TTFT", "TPOT", "Output throughput"],
)
display(HTML(styled_mape.to_html(index=False, na_rep="—", classes="table table-striped table-hover", border=0)))
```

## Artifacts

- [Kimi-K3 GitHub repository](https://github.com/mnmehta/kimi-k3)
- [Latest AIConfigurator artifacts directory](https://github.com/mnmehta/kimi-k3/tree/main/aiconfigurator_estimates/results/kimi-k3-20260913T225810268008Z)
- [Raw report QMD](https://raw.githubusercontent.com/mnmehta/kimi-k3/main/reports/aiconfigurator-kimi-k3.qmd)
