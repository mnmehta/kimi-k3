#!/usr/bin/env bash
# In-pod serve script for Kimi-K3 on SGLang — TP8×PP4 (4×8 H200).
#
# Based on H200 low-latency recipe with override: --tp-size 8 --pp-size 4
# 4 nodes, 8 GPUs/node, 1 PP stage per node.
#
# Required env:
