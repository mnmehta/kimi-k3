...
Post-mortem of bringing up [vLLM multi-node tensor parallel](https://recipes.vllm.ai/moonshotai/Kimi-K3?strategy=multi_node_tp) for `moonshotai/Kimi-K3` on **fozzie** (2×8 H200).
